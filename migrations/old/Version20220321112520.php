 ...
 */
final class Version20220321112520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE infos_user ADD personnality LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', ADD knowledges LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', ADD precise_knowledge LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE infos_user_catalogue (infos_user_id INT NOT NULL, catalogue_id INT NOT NULL, INDEX IDX_DF0E5752A0D63835 (infos_user_id), INDEX IDX_DF0E57524A7843DC (catalogue_id), PRIMARY KEY(infos_user_id, catalogue_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE infos_user DROP personnality, DROP knowledges, DROP precise_knowledge, CHANGE class_type class_type LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', CHANGE bio bio LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
